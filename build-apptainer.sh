...
SINGULARITY_DISABLE_CACHE=True apptainer build --force mongodb.sif docker://mongo:latest

echo "Building Ollama image..."
SINGULARITY_DISABLE_CACHE=True apptainer build --force ollama.sif docker://ollama/ollama

echo "Building Agent image..."
SINGULARITY_DISABLE_CACHE=True apptainer build --force agent.sif docker://adijida/agent:latest